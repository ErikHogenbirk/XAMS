...
public:
    ...
    ClassDef(ReconstructedPosition, 662);
};
...
public:
	...
	Short_t  n_saturated_per_channel[8];
	...
	Float_t  sum_waveform[1251];
	Float_t  sum_waveform_top[1251];
...
public:
	...
	Bool_t  is_channel_suspicious[8];
	Short_t  lone_hits_per_channel[8];
	Short_t  lone_hits_per_channel_before[8];
	Int_t  n_channels;
	Short_t  n_hits_rejected[8];
	Int_t  n_pulses;
	Short_t  n_pulses_per_channel[8];
	Short_t  noise_pulses_in[8];
